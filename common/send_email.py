...
import time
from common.Action import get_config_email, get_path


# 自动发送邮件
class SendEmail:
    data = get_config_email('Email')
...
if __name__ == '__main__':
    ...
    # html_file = SendEmail().acquire_report_address(get_path('/report/html_report/'))
    # SendEmail().send_email(html_file)
    pass